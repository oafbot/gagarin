...
<div id="container" class="clear">
    <article id="page-content">
        ...
        <div id=signup>
            ...
            <h1 class="gagarin" style="">Login</h1>
        ...
        <aside>	
            <h1 style="display:inline-block;color:#aaa;font-size:medium;">Welcome to&nbsp;</h1>
            <h1 class="gagarin" style="display:inline-block;font-size:xx-large;color:#ccc;">
...
-->
            <em>Gagarin</em> is a multi-user platform for creating and sharing 8-bit style RPGs reminiscent of game systems of the 1980s.
            <p>
            Gagarin is built on <em>Laika</em>, a homebrewed bare-bones PHP framework. It is intended more as a proof of concept and certainly not the cat's pajamas, but if you would like to add, modify or otherwise contribute to extending the functionality of this product, both the <em>Laika Framework</em> and <em>Gagarin</em> are licenced under the BSD Lisence; Source code is available upon request. Thanks for your interest!<br />
            <span class="gagarin" style="float:right;font-size:large">Leonard.</span>
            </p>
        </aside>
